...
@property SKAction *jump;

@property SKAction *runForward;

@property SKAction *runBackward;

@property SKAction *idle;
...
- (id)initPlayerWithImage:(NSString *)imageName andName:(NSString *)name {
    ...
    if([super initWithImage:imageName]) {
        ...
        self.jump = [SKAction animateWithTextures:self.jumpTextures timePerFrame:0.033];
